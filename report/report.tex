...
To obtain the mean error of each $\alpha$, we have obtained the error of the resulting GRASP's objective function with respect to the optimal solution for each of the instances. Then, for each $\alpha$ we have calculated the arithmetic mean error. 
